...
<div class="navbar-fixed">
  <nav>
    <div class="nav-wrapper white">
      ...
      <a href="index.php" class="brand-logo grey-text text-darken-1 hide-on-large-only" > <img src="new_logo.png" height="40%" style="margin-top:4.5%;margin-left:5%;" alt=""><span style="font-family: 'Arvo', serif;line-height:90%; font-size:38%;position:relative;margin-top:1%;margin-left:24%"><br>Indian Institute of Technology Bhilai</span></a>
      <!-- responsive logo end-->
