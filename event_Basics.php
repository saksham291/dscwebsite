...
<body>
	...
	<div class="main-carousel" data-flickity='{ "wrapAround":true, "autoPlay":3000}'>
		...
		<div class="carousel-cell"><img class="responsive-img" src="./img/events/280719 (2)-min.jpg"></div>
		<div class="carousel-cell"><img class="responsive-img" src="./img/events/280719 (3)-min.jpg"></div>
		<div class="carousel-cell"><img class="responsive-img" src="./img/events/280719 (4)-min.jpg"></div>
		<div class="carousel-cell"><img class="responsive-img" src="./img/events/280719 (5)-min.jpg"></div>
	</div>
